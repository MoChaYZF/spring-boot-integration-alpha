...
public class EnumBuster<E extends Enum<E>> {
    ...
    private ConstructorAccessor findConstructorAccessor(
        ...
        Constructor<E> declaredConstructor = clazz.getDeclaredConstructor(parameterTypes);
        return reflection.newConstructorAccessor(declaredConstructor);
    }
    ...
    private E constructEnum(Class<E> clazz,
        ...
        params[0] = value;
        params[1] = ordinal;
        System.arraycopy(additional, 0, params, 2, additional.length);
    ...
    private class Memento {
        ...
        private final Map<Field, int[]> savedSwitchFieldValues = new HashMap<>(16);
        ...
        private void undo() throws NoSuchFieldException, IllegalAccessException {
            ...
            Map<String, E> valuesMap = new HashMap<>(16);
            for (E e : values) {
